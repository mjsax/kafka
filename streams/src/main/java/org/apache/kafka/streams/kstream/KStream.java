...
public interface KStream<K, V> {
    ...
    /**
     * Group the records of this {@code KStream} on a new key that is computed by the provided {@link KeyValueMapper}.
     * Because a new key is selected, an internal repartitioning topic will be created in Kafka.
     * See {@link #groupByKey()} for more details.
     *
     * <p>This operation is semantically equivalent to {@link #selectKey(KeyValueMapper)} followed by {@link #groupByKey()}.
     */
