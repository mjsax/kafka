 ...
 */
abstract class BaseJoinProcessorNode<K, VLeft, VRight, VOut> extends GraphNode {

    private final ProcessorParameters<K, VLeft, ?, ?> joinThisProcessorParameters;
    private final ProcessorParameters<K, VRight, ?, ?> joinOtherProcessorParameters;
    private final ProcessorParameters<K, VOut, ?, ?> joinMergeProcessorParameters;
    private final ValueJoinerWithKey<? super K, ? super VLeft, ? super VRight, ? extends VOut> valueJoiner;
    ...
    BaseJoinProcessorNode(final String nodeName,
                          ...
                          final ProcessorParameters<K, VLeft, ?, ?> joinThisProcessorParameters,
                          final ProcessorParameters<K, VRight, ?, ?> joinOtherProcessorParameters,
    ...
    // VisibleForTesting
    public ProcessorParameters<K, VLeft, ?, ?> thisProcessorParameters() {
        return joinThisProcessorParameters;
    }

    // VisibleForTesting
    public ProcessorParameters<K, VRight, ?, ?> otherProcessorParameters() {
