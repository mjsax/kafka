 ...
 * The returned instance should wrap the supplied {@link ProcessorSupplier} and the {@link Processor} it supplies
 ...
 *
 * <p>NOTE: in order to use this feature, you must set the
 * {@link StreamsConfig#PROCESSOR_WRAPPER_CLASS_CONFIG processor.wrapper.class} config and pass it in as a
 * {@link TopologyConfig} when creating the {@link StreamsBuilder} or {@link Topology} by using the appropriate
 * constructor (i.e., {@link StreamsBuilder#StreamsBuilder(TopologyConfig)} or
 * {@link Topology#Topology(TopologyConfig)})
 *
 * <p>Can be configured, if desired, by implementing the {@link #configure(Map)} method.
 * This method will be invoked when the {@code ProcessorWrapper} is instantiated, and will provide it with the
 * {@link TopologyConfig} that were passed in to the {@link StreamsBuilder} or {@link Topology} constructor.
 */
public interface ProcessorWrapper extends Configurable {
     ...
     */
    <KIn, VIn, KOut, VOut> WrappedProcessorSupplier<KIn, VIn, KOut, VOut> wrapProcessorSupplier(
    ...
    /**
     * Convert a {@link ProcessorSupplier} instance into a {@link WrappedProcessorSupplier}.
     */
    ...
    /**
     * Convert a {@link FixedKeyProcessorSupplier} instance into a {@link WrappedFixedKeyProcessorSupplier}.
     */
